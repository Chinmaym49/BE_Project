...
conf = {"host": "remotemysql.com", "user": "ksBrVmnfwV",
        "password": "xwgCNe8x41", "database": "ksBrVmnfwV"}

tags = [(3001, 'c-hash'), (3002, 'java'), (3003, 'php'), (3004, 'javascript'), (3005, 'android'), (3006, 'jquery'), (3007, 'c++'), (3008, 'asp.net'), (3009, 'html'), (3010, '.net'), (3011, 'iphone'), (3012, 'python'), (3013, 'mysql'), (3014, 'sql'), (3015, 'objective-c'), (3016, 'ios'), (3017, 'css'), (3018, 'ruby-on-rails'), (3019, 'windows'), (3020, 'linux'), (3021, 'c'), (3022, 'wpf'), (3023, 'arrays'), (3024, 'sql-server'), (3025, 'asp.net-mvc'), (3026, 'database'), (3027, 'ajax'), (3028, 'xml'), (3029, 'ruby'), (3030, 'eclipse'), (3031, 'xcode'), (3032, 'django'), (3033, 'vb.net'), (3034, 'facebook'), (3035, 'json'), (3036, 'winforms'), (3037, 'html5'), (3038, 'homework'), (3039, 'regex'), (3040, 'asp.net-mvc-3'), (3041, 'bash'), (3042, 'performance'), (3043, 'osx'), (3044, 'forms'), (3045, 'ruby-on-rails-3'), (3046, 'string'), (3047, 'visual-studio-2010'), (3048, 'multithreading'), (3049, 'visual-studio'), (3050, 'algorithm'), (3051, 'web-services'), (3052, 'actionscript-3'), (3053, 'git'), (3054, 'excel'), (3055, 'silverlight'), (3056, 'hibernate'), (3057, 'spring'), (3058, 'apache'), (3059, 'image'), (3060, 'windows-7'), (3061, 'oracle'), (3062, 'security'), (3063, 'query'), (3064, 'wcf'), (3065, '.htaccess'), (3066, 'flash'), (3067, 'linq'), (3068, 'file'), (3069, 'cocoa-touch'), (3070, 'sqlite'), (3071, 'networking'), (3072, 'sql-server-2008'), (3073, 'ubuntu'), (3074, 'oop'), (3075, 'entity-framework'), (3076, 'ipad'), (3077, 'class'), (3078, 'google-chrome'), (3079, 'perl'), (3080, 'api'), (3081, 'codeigniter'), (3082, 'shell'), (3083, 'list'), (3084, 'wordpress'), (3085, 'jsp'), (3086, 'http'), (3087, 'iis'), (3088, 'uitableview'), (3089, 'flex'), (3090, 'jsf'), (3091, 'internet-explorer'), (3092, 'jquery-ui'), (3093, 'vba'), (3094, 'linear-algebra'), (3095, 'apache2'), (3096, 'function'), (3097, 'google-maps'), (3098, 'mvc'), (3099, 'email'), (3100, 'xaml'),
...
search_string = ""
# Enter Server URL
server_url = "http://088096c31dec.ngrok.io"
...
def profile():
    if 'username' in session:
        ...
        query = "Select SUM(votes) from Answer where uid={}".format(session['id'])
        cur.execute(query)
        ...
        cur.close()
        db.close()
        return render_template('profile.html', ques=ques, n=len(ques), tags=tags_list, anscnt=anscnt, users=users, ques_count=ques_count, ans_count = ans_count, vote_count = vote_count)
    else:
        return redirect(url_for('login'))
